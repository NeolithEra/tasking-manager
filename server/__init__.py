...
def init_flask_restful_routes(app):
    ...
    api.add_resource(InterestAPI,                   '/api/v1/interests',endpoint="create_interest", methods=['POST', 'GET'])
    api.add_resource(InterestAPI,                   '/api/v1/interests/<int:interest_id>', methods=['PUT', 'DELETE'])
    api.add_resource(UserInterestRelationshipAPI,   '/api/v1/interests/user', endpoint="create_user_interest", methods=['POST'])
    api.add_resource(UserInterestRelationshipAPI,   '/api/v1/interests/user/<int:user_id>', methods=['GET'])
